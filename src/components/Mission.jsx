      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col md:flex-row gap-3 mt-5 md:mt-0 md:gap-6 md:justify-end md:mr-10">
            ...
            <Button
              className="bg-amber-600 text-white w-40 md:h-20 md:w-20 p-2 font-medium rounded-none"
              onPress={onOpen}
            >
              Give
            </Button>
                  ...
                  <>
                    ...
                    <ModalBody className="text-gray-600 font-medium">
                      <p>
                        ...
                        International School! Your donation will go a long way
                        in helping us continue to provide quality education. To
                        donate, please call our donation line and follow the
                        simple instructions provided by our team.
                      </p>
                      ...
                      <p className="mt-4">
                        Every contribution makes a difference. Thank you for
                        your generosity!
                      </p>
                    </ModalBody>
                    <ModalFooter>
