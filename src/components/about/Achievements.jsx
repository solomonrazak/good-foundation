...
{!hideButton && 
      ...
      <button className="px-2 bg-amber-600 text-white py-1 rounded-md font-medium text-[15px] hover:bg-amber-500" onClick={handleLoadMore}>Load More Achievements</button>
      </div>
}
