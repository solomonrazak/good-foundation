...
const Grid = () => {
  ...
  return (
    <div className="w-full grid grid-cols-1 grid-rows-6 md:grid-cols-10 md:grid-rows-8 gap-4 p-6">
      <div className="border-2 border-dashed border-orange-400 rounded-md md:col-start-1 md:col-span-4 md:row-start-1 md:row-span-3 p-16 text-center" data-aos="fade-up">
      ...
      <div className="border-2 border-dashed border-green-400 rounded-md md:col-start-5 md:col-span-2 md:row-start-1 md:row-span-4 p-14" data-aos="fade-up">
      ...
      <div className="border-2 border-dashed border-blue-400 rounded-md md:col-start-7 md:col-span-4 md:row-start-1 md:row-span-4 p-14" data-aos="fade-up">
      ...
      <div className="border-2 border-dashed border-violet-400 rounded-md md:col-start-1 md:col-span-4 md:row-start-4 md:row-span-5 p-14" data-aos="fade-up">
      ...
      <div className="border-2 border-dashed border-red-400 rounded-md md:col-start-5 md:col-span-4 md:row-start-5 md:row-span-4 p-14" data-aos="fade-up">
        <p className="text-[20px] font-medium text-gray-500 text-center">12 studnets in the average class</p>
      </div>
      <div className="border-2 border-dashed border-indigo-950 rounded-md md:col-start-9 md:col-span-2 md:row-start-5 md:row-span-4 p-14" data-aos="fade-up">
