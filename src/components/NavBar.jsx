...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center px-3 py-2 border-b-4 border-green-400 fixed top-0 w-full bg-white z-40'>
      <Logo />
      ...
      <IoIosMenu className="md:hidden text-[30px]"/>
